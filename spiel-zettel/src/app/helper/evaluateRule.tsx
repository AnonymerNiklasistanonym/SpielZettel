...
export function evaluateRule(ruleSet: SpielZettelRuleSet, element: SpielZettelElement, elements: SpielZettelElement[], states: RefObject<SpielZettelElementState[] | null>): void {
