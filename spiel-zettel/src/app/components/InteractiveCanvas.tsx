...
function InteractiveCanvas() {
  ...
  const debugString = useMemo<string | null>(() => {
    ...
    return `canvasSize=${canvas?.width}x${canvas?.height}, windowSize=${window.innerWidth}x${window.innerHeight}, screenSize=${window.screen.width}x${window.screen.height}`;
  }, [canvasRef, refresh]);
